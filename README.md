...
![Tests](https://img.shields.io/badge/tests-404%20passing-3B8C6E)
...
builds, exercises the model-promotion policy, and runs a 404-test suite. The
...
tests/              404 tests: contracts, gate, quarantine, streaming, observability,
