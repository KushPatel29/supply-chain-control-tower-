...
![Tests](https://img.shields.io/badge/tests-409%20passing-3B8C6E)
...
builds, exercises the model-promotion policy, and runs a 409-test suite. The
...
tests/              409 tests: contracts, gate, quarantine, streaming, observability,
