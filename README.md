...
![Tests](https://img.shields.io/badge/tests-437%20passing-3B8C6E)
...
builds, exercises the model-promotion policy, and runs a 437-test suite. The
...
tests/              437 tests: contracts, gate, quarantine, streaming, observability,
